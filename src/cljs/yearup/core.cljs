...
(defn admin-page []
  ...
  ;       [:i.fa.fa-sign-out
  ;        [:a#navbarDropdown.user-profile {:href "#" :aria-expanded "false"} "Logout"]]]
  ;      ]]]]
  ...
  ;            [:tbody
  ;             [:tr
  ;              [:td [:a {:href "#" :data-toggle "modal" :data-target ".bs-example-modal-lg"} "Tiger Nixon"]] [:td "System Architect"]
  ;              [:td "System Architect"]
  ;              [:td [:span.badge.badge-success "Yes"]]]
  ;             [:tr
  ;              [:td [:a {:href ""} "Simon Okwori"]]
  ;              [:td "Accountant"]
  ;              [:td "System Architect"]
  ;              [:td [:span.badge.badge-danger "No"]]]]]
  ...
  ;           [:input#ratio-percent.form-control {:type "text" :placeholder "60"}]]]
  ;         [:div.item.form-group
  ;          [:div.col-md-6.col-sm-6.offset-md-3
  ;           [:button.btn.btn-success {:type "button"} "Adjust"]]]]]]]]]
  ;   [:br]]
  ;  [:footer
